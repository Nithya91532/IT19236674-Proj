...
public class Project {
	...
	public String readItems()
	{
		...
		try
		{
			...
			output = "<table  class='table table-dark table-striped'><tr><th>Project Code</th>"
			...
			while (rs.next())
			{
				...
				output += "<td><input name='btnUpdate' type='button' value='Update' class='btnUpdate btn btn-secondary' data-itemid='" + itemID + "'></td>"
						+"<td><input name='btnRemove' type='button' value='Delete' class='btnRemove btn btn-danger' data-itemid='" + itemID + "'>" + "</td></tr>";
			}
